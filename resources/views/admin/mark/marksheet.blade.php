                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                  <form method="GET" action="{{ url('/marksheet') }}">
                                      @if(session('success'))
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            ...
            <select name="group" id="group" class="form-select"
                {{ request('standard') && request('standard') <= 10 ? 'disabled' : '' }}>
...
<div class="mt-3">
    ...
    <form method="POST" action="{{ url('/create-mark-table') }}">
        @csrf
        ...
        @foreach($subjects as $sub)
        <input type="hidden" name="subjects[]" value="{{ $sub->subject_name }}">
        @endforeach
